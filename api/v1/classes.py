...
#         self.entry_time = datetime.datetime.now().replace(microsecond=0)
...
#
#         creation_time = time.strptime(row[0], "%Y-%m-%j %H:%M:%S").time()
#
#         # creation_time = row[0]
#         #
#         # ts = time.time()
#         # current_time_str = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
#         #
#         # left_time = current_time_str - creation_time
#
#         return creation_time
#         # current_time = time.strptime(current_time_str, "%H:%M:%S")
#         # dt = datetime.datetime.fromtimestamp(mktime(current_time))
#
...
#         # if (dt - creation_time) > datetime.timedelta(1):
